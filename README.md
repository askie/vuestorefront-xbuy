...
```sh
grep -rl 'xbuy' ./ | xargs sed -i '' 's/xbuy/xbuy/g'
```
...
## Vue Storefront 2 integration with xbuy
...
Want to contribute? Ping us on `xbuy` channel on [our Discord](https://discord.vuestorefront.io)!
...
2. Clone your fork of the repo
    ```
    example:
    git clone https://github.com/vuestorefront/xbuy.git
    cd xbuy
    ```
...
- [xbuy integration Documentation](https://docs.vuestorefront.io/xbuy)
- [Community Chat](https://discord.vuestorefront.io)

## Support

If you have any questions about this integration we will be happy to answer them on `xbuy` channel on [our Discord](discord.vuestorefront.io).
